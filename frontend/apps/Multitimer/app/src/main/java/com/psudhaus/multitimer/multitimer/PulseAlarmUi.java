...
public class PulseAlarmUi extends RelativeLayout {
     ...
     *                theme, resources, etc.
     */
    public PulseAlarmUi(Context context) {
        this(context, null, 0);
    }
     ...
     */
    public PulseAlarmUi(Context context, AttributeSet attrs) {
     ...
     *                     for defaults.
     */
    public PulseAlarmUi(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void build() {
        ...
        for (int index = 0; index < mCount; index++) {
            // setup view
            PulseView pulseView = new PulseAlarmUi.PulseView(getContext());
